        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive" src="../assets/backend/img/user4-128x128.jpg" alt="User profile picture">
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="../assets/backend/img/user1-128x128.jpg" alt="user image">
                        <span class="username">
